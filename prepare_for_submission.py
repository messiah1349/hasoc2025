...
# for language in ['Bodo']:
    ...
    version = 'v2'
    output_file = OUTPUT_PATH / f"{language}_test_ocr_fsp_gemini_scores_{version}.csv"
    ...
    new_file = OUTPUT_PATH / f"{language}_to_submit_gemini_{version}.csv"
